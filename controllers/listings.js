...
module.exports.createListing = async (req, res, next) => {
  ...
  // Step 1 Fix: Validate geocoding result
  if (!geoData) {
    req.flash("error", "Invalid location entered! Please enter a valid place.");
  ...
  newListing.geometry = geoData.geometry; // safe assignment
